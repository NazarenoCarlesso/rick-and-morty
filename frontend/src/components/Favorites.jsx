...
import { Filter, MontserratBold, SelectCustom } from './Custom'
        ...
        <Grid container direction="column" alignItems="center" sx={{ maxWidth: "100%" }} >
            ...
            <Filter>
                <Grid container direction="row" justifyContent="center" alignItems="center" >
                    <MontserratBold sx={{ margin: "10px" }} >Order:</MontserratBold>
                    <SelectCustom value={filter.order} variant="standard" label="Order" defaultValue="Oldest" onChange={handleOrder} sx={{ width: "110px" }} >
                        <MenuItem value="Oldest">Oldest</MenuItem>
                        <MenuItem value="Newest">Newest</MenuItem>
                        <MenuItem value="Ascending">Ascending</MenuItem>
                        <MenuItem value="Descending">Descending</MenuItem>
                    </SelectCustom>
                    <MontserratBold sx={{ margin: "10px" }} >Gender:</MontserratBold>
                    <SelectCustom value={filter.gender} variant="standard" label="Gender" defaultValue="All" onChange={handleFilterGender} sx={{ width: "110px" }} >
                    ...
                    <MontserratBold sx={{ margin: "10px" }} >Specie:</MontserratBold>
                    <SelectCustom value={filter.specie} variant="standard" label="Specie" defaultValue="All" onChange={handleFilterSpecie} sx={{ width: "110px" }} >
                        <MenuItem value="All">All</MenuItem>
                    ...
                    <MontserratBold sx={{ margin: "10px" }} >Status:</MontserratBold>
                    <SelectCustom value={filter.status} variant="standard" label="Status" defaultValue="All" onChange={handleFilterStatus} sx={{ width: "110px" }} >
                        <MenuItem value="All">All</MenuItem>
                        <MenuItem value="Alive">Alive</MenuItem>
                        <MenuItem value="Dead">Dead</MenuItem>
                        <MenuItem value="unknown">Unknown</MenuItem>
                    </SelectCustom>
                    <Button variant="outlined" onClick={handleRestart} sx={{ margin: "10px 16px" }} >
                        Restart
                    </Button>
                </Grid>
            </Filter>
